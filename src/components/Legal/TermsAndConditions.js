    ...
    <Grid container justify='center'>
      <Grid item xs={12} md={10} lg={8}>
        <Card>
          <CardContent>
            Welcome to &nbsp;
            <i>{copyright}</i>. If you continue to browse and use this website you are agreeing to
            comply with and be bound by the following terms and conditions of use, which together
